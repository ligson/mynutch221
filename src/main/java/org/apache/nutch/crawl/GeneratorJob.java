...
public class GeneratorJob extends NutchTool implements Tool {
	...
	public Collection<WebPage.Field> getFields(Job job) {
		...
		fields.addAll(FetchScheduleFactory.getFetchSchedule(
				job.getConfiguration()).getFields());
		return fields;
	}
	...
	public Map<String, Object> run(Map<String, Object> args) throws Exception {
		...
		if (GENERATOR_COUNT_VALUE_HOST.equalsIgnoreCase(mode)) {
			...
			LOG.warn("Unknown generator.max.count mode '" + mode
					+ "', using mode=" + GENERATOR_COUNT_VALUE_HOST);
